...
var VideoChat = {
  ...
  onMediaStream: function (stream) {
    ...
    Snackbar.show({
      text: "Ask the other user to join by saying them the meeting code  " ,
      actionText: "got it",
      width: "750px",
      pos: "top-center",
...
function startUp() {
  ...
  // Set tab title
  document.title = "FerociousMeet- " + url.substring(url.lastIndexOf("/") + 1);
  ...
  captionText.text("Meeting is started waiting for the other user to join...").fadeIn();
